...
'''
    module for global constant variables
'''
...
def initialize_globals(quantum_code=None):
    """
        function to define 1-qubit gate list and 2-qubit gate list
    """
    global list_one_qubit_gates
    global list_two_qubit_gates
    global list_nontransversal_gate
    global list_function_modules
    
    # modules work like a one-qubit function

    # gate classification: one qubit gate, two qubit gate and quantum operation
    list_one_qubit_gates = set([str_gate_h, str_gate_x, str_gate_z, str_gate_y,
                                str_gate_t, str_gate_tdag, str_gate_phase,
                                str_gate_u, str_gate_sx, str_gate_rx, str_gate_ry,
                                str_gate_s, str_gate_sdag, str_gate_rz, str_gate_i,
                                str_gate_prepz, str_gate_prepx, str_gate_measz, str_gate_measx])

    list_two_qubit_gates = set([str_gate_cnot, str_gate_cnoth, str_gate_cnotv,
                                str_gate_cx, str_gate_cz, str_gate_cphase,
                                str_gate_swap, str_gate_swaph, str_gate_swapv,
                                str_move, str_move_back, str_adjoin, str_interCNOT])
